#!/usr/bin/env bash
# Package WeAppHelper as Bootstrap / RootHide .deb
...
APP_DIR="$ROOT_DIR/apps/WeAppHelper"
DIST_DIR="$ROOT_DIR/dist"
DYLIB="$DIST_DIR/WeAppHelper.dylib"
...
cp -f "$DYLIB" "$ROOTFS/Library/MobileSubstrate/DynamicLibraries/WeAppHelper.dylib"
cp -f "$APP_DIR/WeAppHelper.plist" "$ROOTFS/Library/MobileSubstrate/DynamicLibraries/WeAppHelper.plist"

#!/usr/bin/env bash
# Package WCallRecorder as Bootstrap / RootHide .deb
...
APP_DIR="$ROOT_DIR/apps/WCallRecorder"
DIST_DIR="$ROOT_DIR/dist"
DYLIB="$DIST_DIR/WCallRecorder.dylib"
...
cp -f "$DYLIB" "$ROOTFS/Library/MobileSubstrate/DynamicLibraries/WCallRecorder.dylib"
cp -f "$APP_DIR/WCallRecorder.plist" "$ROOTFS/Library/MobileSubstrate/DynamicLibraries/WCallRecorder.plist"
